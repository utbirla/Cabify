...
public class Add_DriverDetails extends JFrame implements ActionListener{
	JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id13;
	JFrame f;
	JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13;
	JButton b,b1;

	public Add_DriverDetails(){
	f=new JFrame("Add griver Details");
	...
	id1=new JLabel("New Driver Details");
	...
	try{
		...
		String q ="insert into driver values('"+username+"','"+name+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+country+"','"+gender+"','"+aadhar+"')";
