...
public class User_SignUp extends JFrame implements ActionListener{
	...
	User_SignUp(){
		...
		//image_additon
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cabmanagement/icons/Namaste.png"));
...
public void actionPerformed(ActionEvent ee) {
	if(ee.getSource()==b1) {
		...
		try
		{
			...
			String q="insert into user_signup values('"+username+"', '"+name+"', '"+password+"', '"+phone+"')";
