...
public class Book_Cab extends JFrame implements ActionListener{
	...
	try
	{
		...
		while(rest1.next())	
		{
			...
			tf9.setText(rest1.getString("stops"));
		}
	}
	catch(Exception exx)
	{
...
if(e.getSource()==bt1) {
			...
			String stops=tf9.getText();
			
			try
			{
				ConnectionClass obj3=new ConnectionClass();
				String q1="insert into intracity values('"+bid+"','"+username+"','"+dname+"','"+car+"','"+source+"','"+destination+"','"+price+"','"+stops+"')";
