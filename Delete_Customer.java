...
public class Delete_Customer  extends JFrame implements ActionListener
{
	...
	Delete_Customer()
	{
		...
		p2=new JPanel();
		p2.setLayout(new GridLayout(11,1,10,10));
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==bt1)
		{
			...
			try
			{
				...
				String q1="delete from intracity where username='"+username+"'";
				int aa=obj3.stm.executeUpdate(q);
				if(aa==1)
				{
					JOptionPane.showMessageDialog(null,"your record succesfully Deleted ");
