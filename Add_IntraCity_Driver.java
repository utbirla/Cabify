...
public class Add_IntraCity_Driver extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==bt1) {
			...
			String stops=tf6.getText();
			
			try {
				ConnectionClass obj=new ConnectionClass();
				String q="insert into intracity_driver(driver,source,destination,car,price,stops) values('"+name+"','"+source+"','"+destination+"','"+car+"','"+price+"','"+stops+"')";
