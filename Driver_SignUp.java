...
public class Driver_SignUp extends JFrame implements ActionListener{
	JFrame f;
	JLabel l1,l2,l3,l4;
	JTextField t1, t2,t3;
	JPasswordField p1;
	...
	Driver_SignUp(){
		...
		//image_additon
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cabmanagement/icons/Key.png"));
...
public void actionPerformed(ActionEvent ee) {
	if(ee.getSource()==b1) {
		...
		try
		{
			...
			String q="insert into driver_signup values('"+username+"', '"+name+"', '"+password+"', '"+phone+"')";
